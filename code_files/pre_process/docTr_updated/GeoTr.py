from code_files.pre_process.docTr_updated.extractor import BasicEncoder
from code_files.pre_process.docTr_updated.position_encoding import build_position_encoding
...
class TransDecoder(nn.Module):
    ...
    def forward(self, imgf, query_embed):
        pos = self.position_embedding(torch.ones(imgf.shape[0], imgf.shape[2], imgf.shape[3]).bool().cpu())  # torch.Size([1, 128, 36, 36])
